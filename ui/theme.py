THEMES = {
    "默认": {
        ...
        "btn_colors": ["#ffaa00",  # 启动设置 - 橙色
                       "#00f0ff", "#39ff14", "#ff003c", "#ffd700", "#ff44cc", "#a200ff"],
    ...
    "极光紫": {
        ...
        "btn_colors": ["#ff8800",  # 启动设置 - 橙色
                       "#a200ff", "#d400ff", "#ff00ff", "#ff44cc", "#fe019a", "#a200ff"],
    ...
    "赛博粉": {
        ...
        "btn_colors": ["#ff7700",  # 启动设置
                       "#ff44cc", "#ff69b4", "#ff1493", "#ff00ff",
                       "#ff44cc",  # 加入我们（修正为粉紫，不再黄色）
                       "#ff44cc"],  # 驾驶
    ...
    "荧光蓝": {
        ...
        "btn_colors": ["#ff9900",  # 启动设置
                       "#00f0ff", "#00bfff", "#1e90ff", "#00ced1", "#40e0d0", "#00f0ff"],
